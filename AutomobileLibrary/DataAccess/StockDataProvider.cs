    ...
    public class StockDataProvider
    {
            ...
            out SqlConnection connection, params SqlParameter[] parameters)
        {
            ...
            try
            {
                ...
                var command = new SqlCommand(commandText, connection); command.CommandType = commandType;
                if (parameters != null) { foreach (var parameter in parameters) { command.Parameters.Add(parameter); } }
        ...
        params SqlParameter[] parameters)
        {
            ...
            } catch (Exception ex) { throw new Exception("Data Provider: Delete Method", ex.InnerException); }
        }
